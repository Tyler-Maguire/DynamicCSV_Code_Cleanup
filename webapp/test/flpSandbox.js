		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic CSV Compare Tool",
									"targetURL": "#comepiusedynamcsv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comepiusedynamcsv-display": {
								"semanticObject": "comepiusedynamcsv",
								"action": "display",
								"description": "Dynamically Compare CSV Files",
								"title": "Dynamic CSV Compare Tool",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.epiuse.dynamcsv",
									"url": sap.ui.require.toUrl("com/epiuse/dynamcsv")
								}
							}
						}
					}
